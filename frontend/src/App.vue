<template>
  <div id="app">
    ...
    <aside class="layout-sidebar">
      <div class="logo-area">
        <img src="/logo.png" alt="AI圖文生成器" class="logo-icon" />
        <span class="logo-text">AI圖文</span>
      </div>
      ...
      <div style="margin-top: auto; padding-top: 20px; border-top: 1px solid var(--border-color);">
        <div style="display: flex; align-items: center; gap: 10px;">
          <img src="/logo.png" alt="AI圖文生成器" style="width: 36px; height: 36px; border-radius: 50%; object-fit: cover;" />
          <div>
            <div style="font-size: 14px; font-weight: 600;">AI 圖文</div>
            <div style="font-size: 12px; color: var(--text-sub);">Blog Generator</div>
          </div>
        </div>
      </div>
    </aside>
        ...
        <footer v-if="route.path !== '/'" class="global-footer">
          <div class="footer-content">
            ...
            <div class="footer-license">
              Based on <a href="https://github.com/HisMax/RedInk" target="_blank" rel="noopener noreferrer">RedInk</a> | Licensed under <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank" rel="noopener noreferrer">CC BY-NC-SA 4.0</a>
            </div>
          </div>
        </footer>
      </RouterView>
